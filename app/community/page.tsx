    ...
    <main className="min-h-screen grid place-items-center p-6 bg-gradient-to-br from-cross-light via-cross-heavenly to-cross-sky">
      <section className="text-center max-w-4xl">
        ...
        <div className="mt-12 flex flex-wrap gap-5 justify-center">
          <SocialButton href="https://x.com/i/communities/1957861014999081048" label="X Community" className="bg-gradient-to-r from-white to-black text-white shadow-cross" />
          <SocialButton href="https://x.com/i/communities/1957861014999081048" label="Join Community" className="bg-gradient-to-r from-black to-white text-black shadow-heavenly" />
        </div>
      </section>
