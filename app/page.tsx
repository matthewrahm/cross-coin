    ...
    <main className="min-h-screen p-4 sm:p-6 grid place-items-center bg-gradient-to-br from-cross-light via-cross-heavenly to-cross-sky">
      <section className="text-center max-w-4xl mx-auto px-2 sm:px-0">
        ...
        <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto justify-items-center px-2 sm:px-0">
          <CloudCard delay={0.3}>
            <div className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4 rounded-full bg-gradient-to-br from-cross-gold via-cross-sky/80 to-white/40 flex items-center justify-center shadow-[0_8px_20px_rgba(255,215,0,0.4)] group-hover:shadow-[0_12px_28px_rgba(255,215,0,0.6)] transition-all duration-300 mx-auto">
          ...
          <CloudCard delay={0.5} className="sm:col-span-2 lg:col-span-1">
            <div className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4 rounded-full bg-gradient-to-br from-cross-gold/80 via-cross-sky to-white/40 flex items-center justify-center shadow-[0_8px_20px_rgba(255,215,0,0.4)] group-hover:shadow-[0_12px_28px_rgba(255,215,0,0.6)] transition-all duration-300 mx-auto">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
