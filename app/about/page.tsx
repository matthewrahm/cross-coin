    ...
    <main className="min-h-screen p-6 grid grid-rows-[1fr_auto] bg-gradient-to-br from-cross-light via-cross-heavenly to-cross-sky">
      <section className="text-center max-w-4xl mx-auto self-center">
        <motion.div
          ...
          className="mb-8"
        >
          <h2 className="text-4xl sm:text-6xl md:text-7xl font-bold leading-tight text-black">
            Faith & Community
          </h2>
          <p className="mt-6 text-lg sm:text-xl text-black/80 leading-relaxed max-w-md mx-auto">
        ...
        >
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-cross-gold/20 shadow-cross">
            <h3 className="font-semibold text-black mb-3 text-lg">Our Mission</h3>
            <p className="text-black/80">To unite believers in a shared mission of faith, hope, and divine purpose through the power of community and technology.</p>
          </div>
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-cross-sky/20 shadow-heavenly">
            <h3 className="font-semibold text-black mb-3 text-lg">Our Values</h3>
            <p className="text-black/80">Faith, integrity, community, service, and the belief that together we can create something greater than ourselves.</p>
          </div>
        </motion.div>
      </section>
    </main>
