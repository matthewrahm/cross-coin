...
export function PricePanel({ title = 'Cross Coin Live Price & Market Cap' }: PricePanelProps) {
  ...
  return (
    <div className="rounded-2xl bg-white/70 backdrop-blur-sm p-6 shadow-soft border border-cross-sky/20">
      <div className="flex items-center gap-4">
        <div className="grid h-12 w-12 place-items-center rounded-full bg-gradient-to-r from-cross-gold to-cross-sky text-white text-xl font-bold shadow-cross">
          {icon}
        </div>
        <div>
